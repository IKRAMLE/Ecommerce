...
const Newsletter = () => {
  ...
  return (
    <section className="py-16 lg:py-24 bg-gradient-to-br from-pink-500 to-rose-400">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <p className="text-lg lg:text-xl mb-8 text-pink-100">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="relative flex-1">
                ...
                <Input
                  ...
                  className="pl-10 pr-4 py-3 bg-white border-0 rounded-full text-gray-800 placeholder-gray-500 focus:ring-2 focus:ring-white focus:ring-opacity-50"
                  required
                />
              </div>
              <Button
                ...
                className="bg-white text-pink-500 hover:bg-gray-100 px-8 py-3 rounded-full font-medium transition-all duration-200 disabled:opacity-50"
              >
          ...
          <div className="mt-12 flex flex-wrap justify-center items-center gap-8 text-pink-100">
            ...
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 bg-white rounded-full"></div>
              <span className="text-sm">Weekly Beauty Tips</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 bg-white rounded-full"></div>
